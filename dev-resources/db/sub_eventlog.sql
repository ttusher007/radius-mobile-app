...
--
-- Table structure for table `sub_eventlog`
--

CREATE TABLE `sub_eventlog` (
...
--
-- Indexes for table `sub_eventlog`
--
ALTER TABLE `sub_eventlog`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `sub_eventlog`
--
ALTER TABLE `sub_eventlog`
